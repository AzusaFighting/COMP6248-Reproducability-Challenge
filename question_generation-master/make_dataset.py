...
def concatenate_data(squad_data_dir,  out_dir, env="train", full_context=False):
...
if __name__ == "__main__":
    ...
    concatenate_data(config.squad_data_dir, config.out_dir, env="train", full_context=config.paragraph)
    concatenate_data(config.squad_data_dir, config.out_dir, env="dev", full_context=config.paragraph)
